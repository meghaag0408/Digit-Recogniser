...
def CreateConfusionMatrix(predictions, actual_classes, noOfClasses):
    ...
    for i in range(10):
        for j in range(10):
            index = i*10+j
            L.append(confusion_matrix[index])
...
def SGD(training_inputs, training_label, testing_label, testing_final_inputs, testing_final_labels, epochs, mini_batch_size, eta, noOfClasses, biases, weights, lmbda):  
    ...
    for iteration in range(6):
        ...
        for j in xrange(epochs):
            ...
            for mini_batch in mini_batches:
                biases, weights = update_mini_batch(mini_batch, eta, biases, weights, lmbda, n)
...
def update_mini_batch(mini_batch, eta, biases, weights, lmbda, n):
...
if __name__ == '__main__':
    ...
    SGD(training_data, training_results, train_label, test_inputs, test_labels, 5, 10, 0.5, 10, biases, weights, 0.01)
